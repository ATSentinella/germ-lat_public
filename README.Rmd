...
TB <- getToleranceBreadth(fromfile = F) #Set to T to not rerun everything, F to rerun
...
CM <- getCM(fromfile = F) #Set to T to get results from file, set to F to rerun analyses
...
WR <- getWR(fromfile = F) #Set to T to not rerun everything, set to F to rerun
...
data_tex <- xtable::print.xtable(xtable::xtable(data_appendix), 
                                 print.results = T, 
                                 file= "Outputs/data-appendix.tex")
